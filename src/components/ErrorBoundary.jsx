            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-cream-50 px-4">
                    <div className="max-w-md w-full text-center">
                        ...
                        <h1 className="text-3xl font-black text-charcoal-950 mb-4 tracking-tight">Application Error</h1>
                        <p className="text-charcoal-600 mb-8 font-medium">
                            An unexpected issue occurred. We've been notified and are working on a fix.
                        </p>
                        <button
